...
TEST(LexerTest, Keywords) {
  EXPECT_TRUE(compare_tokens_types_and_symbols(
      ...
      "default defer div do else enum extern false finally for forward from "
      "fun if "
      ...
      "return throw true try try_compile using val virtual when while with "
      "yield",
      {TokenType::UNDERSCORE,
       ...
       TokenType::PUBLIC,
       TokenType::PURE,
       TokenType::REINTERPRET_CAST,
       TokenType::RETURN,
       TokenType::THROW,
       TokenType::TRUE,
       TokenType::TRY,
       TokenType::TRY_COMPILE,
       TokenType::USING,
       TokenType::VAL,
       TokenType::VIRTUAL,
       TokenType::WHEN,
